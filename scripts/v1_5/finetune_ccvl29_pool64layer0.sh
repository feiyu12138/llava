...
deepspeed llava/train/train_mem.py \
    ...
    --bf16 True \
    --output_dir /data/datasets/jchen293/weights/llava/checkpoint/llava-v1.5-7b-stride-$stride-layer-$layer-grouping-$grouping-v2 \
    --num_train_epochs 1 \
    ...
    --report_to wandb \
    --run_name pool64layer0 \
    --stride $stride \
    --layer $layer \
    --grouping $grouping \
    > /data/datasets/jchen293/logs/exp/llava/pool4layer0.log
