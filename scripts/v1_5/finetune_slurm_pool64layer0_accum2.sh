#!/bin/bash
#
#SBATCH --job-name=pool64layer0_accum2
#SBATCH --error=/datasets/jchen293/logs/exp/llava/pool64layer0_accum2.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava/pool64layer0_accum2.out
#SBATCH --gpus=8
#SBATCH --nodes=1
