#!/bin/bash
#
#SBATCH --job-name=pt_pool4layer_1
#SBATCH --error=/datasets/jchen293/logs/exp/llava/pt_pool4layer_1.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava/pt_pool4layer_1.out
#SBATCH --gpus=8
#SBATCH --nodes=1
