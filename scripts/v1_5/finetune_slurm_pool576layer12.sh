#!/bin/bash
#
#SBATCH --job-name=pool576layer12
#SBATCH --error=/datasets/jchen293/logs/exp/llava/pool576layer12.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava/pool576layer12.out
#SBATCH --gpus=8
#SBATCH --nodes=1
