...
deepspeed llava/train/train_mem.py \
    ...
    --report_to wandb \
    --run_name pt_pool4layer1_hardkmeans \
    --stride $stride \
    --layer $layer \
    --grouping $grouping \
    > /data/datasets/jchen293/logs/exp/llava/pt_pool4layer1_hardkmeans.log
...
deepspeed llava/train/train_mem.py \
    ...
    --lazy_preprocess True \
    --report_to wandb \
    --run_name pool4layer1_hardkmeans \
    --stride $stride \
    --layer $layer \
    --grouping $grouping \
    > /data/datasets/jchen293/logs/exp/llava/pool4layer1_hardkmeans.log
