#!/bin/bash
#
#SBATCH --job-name=pool4layer16-multi
#SBATCH --error=/datasets/jchen293/logs/exp/llava/pool4layer16-multi.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava/pool4layer16-multi.out
#SBATCH --gpus=8
#SBATCH --nodes=1
...
deepspeed llava/train/train_mem.py \
    ...
    --group_by_modality_length True \
    --bf16 True \
    --output_dir $ROOT_WEIGHT/llava-v1.5-7b-stride-$stride-layer-$layer-grouping-$grouping-v4 \
    --num_train_epochs 1 \
    --per_device_train_batch_size 16 \
    --per_device_eval_batch_size 4 \
    --gradient_accumulation_steps 1 \
