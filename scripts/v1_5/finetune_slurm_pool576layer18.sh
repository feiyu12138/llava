#!/bin/bash
#
#SBATCH --job-name=pool576layer18
#SBATCH --error=/datasets/jchen293/logs/exp/llava/pool576layer18.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava/pool576layer18.out
#SBATCH --gpus=8
#SBATCH --nodes=1
