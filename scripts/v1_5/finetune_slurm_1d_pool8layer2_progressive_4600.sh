#!/bin/bash
#
#SBATCH --job-name=1dpool8layer2prog4600
#SBATCH --error=/datasets/jchen293/logs/exp/llava/1dpool8layer2prog4600.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava/1dpool8layer2prog4600.out
#SBATCH --gpus=8
#SBATCH --nodes=1
...
deepspeed llava/train/train_mem.py \
    ...
    --report_to wandb \
    --run_name 1dpool8layer2prog4600 \
    --stride $stride \
    --layer $layer \
    --grouping $grouping \
