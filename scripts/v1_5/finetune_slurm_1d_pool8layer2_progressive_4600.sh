...
#SBATCH --error=/datasets/jchen293/logs/exp/llava/1dpool8layer2progressive4600.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava/1dpool8layer2progressive4600.out
#SBATCH --gpus=8
#SBATCH --nodes=1
