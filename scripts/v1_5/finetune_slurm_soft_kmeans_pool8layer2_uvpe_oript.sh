#!/bin/bash
#
#SBATCH --job-name=sk_oript
#SBATCH --error=/datasets/jchen293/logs/exp/llava/pool8layer2skuvpeoript.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava/pool8layer2skuvpeoript.out
#SBATCH --gpus=8
#SBATCH --nodes=1
...
deepspeed llava/train/train_mem.py \
    ...
    --report_to wandb \
    --run_name pool8layer2softkmeansuvpeoript \
    --stride $stride \
    --layer $layer \
    --grouping $grouping \
