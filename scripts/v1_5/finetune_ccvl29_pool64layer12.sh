...
deepspeed llava/train/train_mem.py \
    ...
    --bf16 True \
    --output_dir $ROOT_WEIGHT/llava-v1.5-7b-pretrain-stride-64-layer-12-grouping-$grouping \
    --num_train_epochs 1 \
...
deepspeed llava/train/train_mem.py \
    ...
    --vision_tower openai/clip-vit-large-patch14-336 \
    --pretrain_mm_mlp_adapter $ROOT_WEIGHT/llava-v1.5-7b-pretrain-stride-64-layer-12-grouping-$grouping/mm_projector.bin \
    --mm_projector_type mlp2x_gelu \
    --mm_vision_select_layer -2 \
    --mm_use_im_start_end False \
    --mm_use_im_patch_token False \
    ...
    --bf16 True \
    --output_dir $ROOT_WEIGHT/llava-v1.5-7b-stride-64-layer-12-grouping-$grouping \
    --num_train_epochs 1 \
