#!/bin/bash
#
#SBATCH --job-name=pool16layer1_kmeans
#SBATCH --error=/datasets/jchen293/logs/exp/llava/pool16layer1_kmeans.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava/pool16layer1_kmeans.out
#SBATCH --gpus=8
#SBATCH --nodes=1
...
deepspeed llava/train/train_mem.py \
    ...
    --report_to wandb \
    --run_name pt_pool16layer1_kmeans \
    --stride $stride \
    --layer $layer \
    --grouping $grouping
