#!/bin/bash
#
#SBATCH --job-name=pool64layer2
#SBATCH --error=/datasets/jchen293/logs/exp/llava/pool64layer2-v2.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava/pool64layer2-v2.out
#SBATCH --gpus=8
#SBATCH --nodes=1
...
deepspeed llava/train/train_mem.py \
    ...
    --pretrain_mm_mlp_adapter $ROOT_WEIGHT/llava-v1.5-7b-pretrain-stride-64-layer-2-grouping-avgpool1d/mm_projector.bin \
