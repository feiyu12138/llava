#!/bin/bash
#
#SBATCH --job-name=pool4layer8_kmeans
#SBATCH --error=/datasets/jchen293/logs/exp/llava/pool4layer8_kmeans.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava/pool4layer8_kmeans.out
#SBATCH --gpus=8
#SBATCH --nodes=1
...
deepspeed llava/train/train_mem.py \
    ...
    --report_to wandb \
    --run_name pt_pool4layer8_kmeans \
    --stride $stride \
    --layer $layer \
    --grouping $grouping
