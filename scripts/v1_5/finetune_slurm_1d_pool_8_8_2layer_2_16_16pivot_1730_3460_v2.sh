#!/bin/bash
#
#SBATCH --job-name=1d_pool_8_8_2layer_2_16_16pivot_1730_3460_v2
#SBATCH --error=/datasets/jchen293/logs/exp/llava/1d_pool_8_8_2layer_2_16_16pivot_1730_3460_v2.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava/1d_pool_8_8_2layer_2_16_16pivot_1730_3460_v2.out
#SBATCH --gpus=8
#SBATCH --nodes=1
...
grouping=avgpool1d
progressive=True
name=1d_pool_8_8_2layer_2_16_16pivot_1730_3460_v2
