#!/bin/bash
#
#SBATCH --job-name=vccpool32layer16fine1
#SBATCH --error=/datasets/jchen293/logs/exp/llava/vccpool32layer16fine1.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava/vccpool32layer16fine1.out
#SBATCH --gpus=8
#SBATCH --nodes=1
...
deepspeed llava/train/train_mem.py \
    ...
    --report_to wandb \
    --run_name ptvccpool32layer16fine1 \
    --stride $stride \
    --layer $layer \
    --grouping $grouping \
...
deepspeed llava/train/train_mem.py \
    ...
    --lazy_preprocess True \
    --report_to wandb \
    --run_name vccpool32layer16fine1 \
    --stride $stride \
    --layer $layer \
    --grouping $grouping \
    --num_fine_blocks $num_fine_blocks \
