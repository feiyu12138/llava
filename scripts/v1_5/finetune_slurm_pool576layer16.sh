#!/bin/bash
#
#SBATCH --job-name=pool576layer16
#SBATCH --error=/datasets/jchen293/logs/exp/llava/pool576layer16.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava/pool576layer16.out
#SBATCH --gpus=8
#SBATCH --nodes=1
