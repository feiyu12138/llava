#!/bin/bash
#
#SBATCH --job-name=2dpool4layer3
#SBATCH --error=/datasets/jchen293/logs/exp/llava/2dpool4layer3.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava/2dpool4layer3.out
#SBATCH --gpus=8
#SBATCH --nodes=1
