#!/bin/bash
#
#SBATCH --job-name=pool64layer0
#SBATCH --error=/datasets/jchen293/logs/exp/llava/pool64layer0.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava/pool64layer0.out
#SBATCH --gpus=8
#SBATCH --nodes=1
