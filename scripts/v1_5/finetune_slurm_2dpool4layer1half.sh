#!/bin/bash
#
#SBATCH --job-name=2dpool4layer1half
#SBATCH --error=/datasets/jchen293/logs/exp/llava/2dpool4layer1half.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava/2dpool4layer1half.out
#SBATCH --gpus=8
#SBATCH --nodes=1
