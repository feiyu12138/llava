#!/bin/bash
#
#SBATCH --job-name=pt_2dpool4layer8half
#SBATCH --error=/datasets/jchen293/logs/exp/llava/pt_2dpool4layer8half.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava/pt_2dpool4layer8half.out
#SBATCH --gpus=8
#SBATCH --nodes=1
