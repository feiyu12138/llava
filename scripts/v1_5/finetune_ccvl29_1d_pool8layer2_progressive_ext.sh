...
deepspeed llava/train/train_mem.py \
    ...
    --data_path_ext $ROOT_DATA/LLaVA-Tuning/llava_v1_5_mix665k_ext.json \
    ...
    --lazy_preprocess True \
    --report_to wandb \
    --run_name 1dpool8layer2progressiveext \
    --stride $stride \
    --layer $layer \
    --grouping $grouping \
    --unified_vpe $unified_vpe \
    --progressive $progressive \
    1> /data/datasets/jchen293/logs/exp/llava/$grouping-stride-$stride-layer-$layer-progressive-ext.out \
    2> /data/datasets/jchen293/logs/exp/llava/$grouping-stride-$stride-layer-$layer-progressive-ext.err
