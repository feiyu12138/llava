#!/bin/bash
#
#SBATCH --job-name=1dpool8layer2_16pivot1730_3460
#SBATCH --error=/datasets/jchen293/logs/exp/llava/1dpool8layer2_16pivot1730_3460.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava/1dpool8layer2_16pivot1730_3460.out
#SBATCH --gpus=8
#SBATCH --nodes=1
