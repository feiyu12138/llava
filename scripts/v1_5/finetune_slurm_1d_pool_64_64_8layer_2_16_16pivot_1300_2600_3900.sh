#!/bin/bash
#
#SBATCH --job-name=1dpool64_64_8layer2_16_16pivot1300_2600_3900prog
#SBATCH --error=/datasets/jchen293/logs/exp/llava/1dpool64_64_8layer2_16_16pivot1300_2600_3900prog.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava/1dpool64_64_8layer2_16_16pivot1300_2600_3900prog.out
#SBATCH --gpus=8
#SBATCH --nodes=1
