#!/bin/bash
#
#SBATCH --job-name=2dpool8layer16
#SBATCH --error=/datasets/jchen293/logs/exp/llava/2dpool8layer16.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava/2dpool8layer16.out
#SBATCH --gpus=8
#SBATCH --nodes=1
