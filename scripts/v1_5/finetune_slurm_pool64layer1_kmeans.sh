#!/bin/bash
#
#SBATCH --job-name=pool64layer1_kmeans
#SBATCH --error=/datasets/jchen293/logs/exp/llava/pool64layer1_kmeans.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava/pool64layer1_kmeans.out
#SBATCH --gpus=8
#SBATCH --nodes=1
...
deepspeed llava/train/train_mem.py \
    ...
    --bf16 True \
    --output_dir $ROOT_WEIGHT/checkpoint/llava-v1.5-7b-pretrain-stride-$stride-layer-$layer-grouping-$grouping \
    --num_train_epochs 1 \
    ...
    --report_to wandb \
    --run_name pt_pool64layer1_kmeans \
    --stride $stride \
    --layer $layer \
    --grouping $grouping
