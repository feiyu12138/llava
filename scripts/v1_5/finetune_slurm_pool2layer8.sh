#!/bin/bash
#
#SBATCH --job-name=pool2layer8
#SBATCH --error=/datasets/jchen293/logs/exp/llava/pool2layer8.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava/pool2layer8.out
#SBATCH --gpus=8
#SBATCH --nodes=1
