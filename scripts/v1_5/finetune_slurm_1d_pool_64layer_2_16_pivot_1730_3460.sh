#!/bin/bash
#
#SBATCH --job-name=1dpool_64layer2_16pivot1730_3460prog
#SBATCH --error=/datasets/jchen293/logs/exp/llava/1dpool_64layer2_16pivot1730_3460prog.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava/1dpool_64layer2_16pivot1730_3460prog.out
#SBATCH --gpus=8
#SBATCH --nodes=1
