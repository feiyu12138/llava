#!/bin/bash
#
#SBATCH --job-name=pool64layer16_v3
#SBATCH --error=/datasets/jchen293/logs/exp/llava/pool64layer16_v3.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava/pool64layer16_v3.out
#SBATCH --gpus=8
#SBATCH --nodes=1
