#!/bin/bash
#
#SBATCH --job-name=1dpool16layer2progressive
#SBATCH --error=/datasets/jchen293/logs/exp/llava/1dpool16layer2progressive.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava/1dpool16layer2progressive.out
#SBATCH --gpus=8
#SBATCH --nodes=1
...
deepspeed llava/train/train_mem.py \
    ...
    --bf16 True \
    --output_dir  $ROOT_WEIGHT/1dpool16layer2progressive \
    --num_train_epochs 1 \
    ...
    --lazy_preprocess True \
    --report_to wandb \
    --run_name 1dpool16layer2progressive \
    --stride $stride \
    --layer $layer \
    --grouping $grouping \
    --unified_vpe $unified_vpe \
    --progressive $progressive \
    # 1> /data/datasets/jchen293/logs/exp/llava/1dpool16layer2progressive.out \
    # 2> /data/datasets/jchen293/logs/exp/llava/1dpool16layer2progressive.err
