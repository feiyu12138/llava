#!/bin/bash
#
#SBATCH --job-name=pt_MSAgate2layer16_k3_rps
#SBATCH --error=/datasets/jchen293/logs/exp/llava/pt_MSAgate2layer16_k3_rps.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava/pt_MSAgate2layer16_k3_rps.out
#SBATCH --gpus=8
#SBATCH --nodes=1
...
deepspeed llava/train/train_mem.py \
    ...
    --report_to wandb \
    --run_name pt_MSAgate2layer16_k3_rps \
    --stride $stride \
    --layer $layer \
    --grouping $grouping \
