#!/bin/bash
#
#SBATCH --job-name=1dpool64layer2proghighlight
#SBATCH --error=/datasets/jchen293/logs/exp/llava/1dpool64layer2proghighlight.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava/1dpool64layer2proghighlight.out
#SBATCH --gpus=8
#SBATCH --nodes=1
