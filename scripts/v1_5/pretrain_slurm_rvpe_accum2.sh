#!/bin/bash
#
#SBATCH --job-name=pt_rvpe_accum2
#SBATCH --error=/datasets/jchen293/logs/exp/llava/pt_rvpe_accum2.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava/pt_rvpe_accum2.out
#SBATCH --gpus=8
#SBATCH --nodes=1
...
deepspeed llava/train/train_mem.py \
    ...
    --bf16 True \
    --output_dir /datasets/jchen293/weights/llava/checkpoint/llava-v1.5-7b-pretrain-rvpe \
    --num_train_epochs 1 \
