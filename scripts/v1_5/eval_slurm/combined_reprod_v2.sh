#!/bin/bash
#
#SBATCH --job-name=reprodv2
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/reprodv2.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/reprodv2.out
#SBATCH --gpus=8
#SBATCH --nodes=1
