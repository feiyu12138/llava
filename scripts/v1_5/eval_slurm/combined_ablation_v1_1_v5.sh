#!/bin/bash
#
#SBATCH --job-name=v1_1_v5_combined
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/v1_1_v5_combined_jc.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/v1_1_v5_combined_jc.out
#SBATCH --gpus=8
#SBATCH --nodes=1
