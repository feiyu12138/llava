...
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/pool64layer0prog4600_vqav2.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/pool64layer0prog4600_vqav2.out
#SBATCH --gpus=8
#SBATCH --nodes=1
