#!/bin/bash
#
#SBATCH --job-name=1dpool16layer2progressive_textvqa
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/1dpool16layer2progressive_textvqa.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/1dpool16layer2progressive_textvqa.out
#SBATCH --gpus=1
#SBATCH --nodes=1
