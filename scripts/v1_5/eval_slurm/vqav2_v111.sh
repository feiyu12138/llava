#!/bin/bash
#
#SBATCH --job-name=vqav2_v111
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/v111_vqav2.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/v111_vqav2.out
#SBATCH --gpus=8
#SBATCH --nodes=1
