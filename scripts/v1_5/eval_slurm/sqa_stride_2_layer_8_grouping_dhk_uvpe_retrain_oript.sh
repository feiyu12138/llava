...
#
#SBATCH --job-name=sqa
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/dhkpool8layer2uvpeoript_sqa.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/dhkpool8layer2uvpeoript_sqa.out
#SBATCH --gpus=1
#SBATCH --nodes=1
