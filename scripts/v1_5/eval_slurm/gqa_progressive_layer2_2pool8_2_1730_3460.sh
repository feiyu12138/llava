#!/bin/bash
#
#SBATCH --job-name=1dpool8_2layer2_2pivot1730_3460_gqa
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/1dpool8_2layer2_2pivot1730_3460_gqa.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/1dpool8_2layer2_2pivot1730_3460_gqa.out
#SBATCH --gpus=8
#SBATCH --nodes=1
