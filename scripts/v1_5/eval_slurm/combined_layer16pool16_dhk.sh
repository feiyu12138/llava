#!/bin/bash
#
#SBATCH --job-name=1dpool16layer16_dhk_combined
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/1dpool16layer16_dhk_combined.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/1dpool16layer16_dhk_combined.out
#SBATCH --gpus=8
#SBATCH --nodes=1
...
CKPT=$ROOT_WEIGHT/llava-v1.5-7b-stride-16-layer-16-grouping-detach_hard_k_means
NAME=1dpool16layer16_dhk
