#!/bin/bash
#
#SBATCH --job-name=1dpool64layer2proghighlight_vizwiz
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/1dpool64layer2proghighlight_vizwiz.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/1dpool64layer2proghighlight_vizwiz.out
#SBATCH --gpus=1
#SBATCH --nodes=1
