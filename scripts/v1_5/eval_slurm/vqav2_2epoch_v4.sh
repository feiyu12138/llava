#!/bin/bash
#
#SBATCH --job-name=vqav2_2epoch_V4
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/2epoch_V4_vqav2.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/2epoch_V4_vqav2.out
#SBATCH --gpus=8
#SBATCH --nodes=1
