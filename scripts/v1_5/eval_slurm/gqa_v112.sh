#!/bin/bash
#
#SBATCH --job-name=v112_gqa
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/v112_gqa.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/v112_gqa.out
#SBATCH --gpus=8
#SBATCH --nodes=1
