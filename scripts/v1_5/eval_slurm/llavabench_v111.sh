#!/bin/bash
#
#SBATCH --job-name=v111_llavaw
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/v111_llavaw.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/v111_llavaw.out
#SBATCH --gpus=1
#SBATCH --nodes=1
