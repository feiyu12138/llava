...
#
#SBATCH --job-name=sqa
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/pool8layer2prog2600mixaug_sqa.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/pool8layer2prog2600mixaug_sqa.out
#SBATCH --gpus=1
#SBATCH --nodes=1
