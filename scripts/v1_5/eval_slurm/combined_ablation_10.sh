#!/bin/bash
#
#SBATCH --job-name=ablation_10_combined
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/ablation_10_combined.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/ablation_10_combined.out
#SBATCH --gpus=8
#SBATCH --nodes=1
