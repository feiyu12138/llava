...
#
#SBATCH --job-name=mme
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/attnpool16layer2fine3cur_mme.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/attnpool16layer2fine3cur_mme.out
#SBATCH --gpus=1
#SBATCH --nodes=1
