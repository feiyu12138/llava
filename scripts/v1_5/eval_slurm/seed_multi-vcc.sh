...
NAME1=vccpool8layer2-infer

CKPT2=$ROOT_WEIGHT/llava-v1.5-7b-stride-$stride-layer-$layer-grouping-$grouping-num_fine_block-$num_fine_blocks
NAME2=vccpool8layer2

run_seed $CKPT1 $NAME1 $num_fine_blocks $layer $stride $grouping
run_seed $CKPT2 $NAME2 $num_fine_blocks $layer $stride $grouping