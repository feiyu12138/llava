...
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/attnpool16layer2fine3controlexp_pope.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/attnpool16layer2fine3controlexp_pope.out
#SBATCH --gpus=1
#SBATCH --nodes=1
