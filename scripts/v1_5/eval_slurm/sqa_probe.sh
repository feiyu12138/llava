#!/bin/bash
#
#SBATCH --job-name=pool8layer2inferunpool_sqa
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/pool8layer2inferunpool_sqa.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/pool8layer2inferunpool_sqa.out
#SBATCH --gpus=1
#SBATCH --nodes=1
