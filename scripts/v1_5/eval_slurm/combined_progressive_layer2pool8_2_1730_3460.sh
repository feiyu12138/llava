#!/bin/bash
#
#SBATCH --job-name=1dpool8_2layer2_2pivot1730_3460_combined
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/1dpool8_2layer2_2pivot1730_3460_combined.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/1dpool8_2layer2_2pivot1730_3460_combined.out
#SBATCH --gpus=8
#SBATCH --nodes=1
...
CKPT=$ROOT_WEIGHT/llava-v1.5-7b-1dpool8_2layer2_2pivot1730_3460
