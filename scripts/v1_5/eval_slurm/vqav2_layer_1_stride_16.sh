#!/bin/bash
#
#SBATCH --job-name=vqav2_1dpool16layer1
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/1dpool16layer1_vqav2.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/1dpool16layer1_vqav2.out
#SBATCH --gpus=8
#SBATCH --nodes=1
