#!/bin/bash
#
#SBATCH --job-name=1dpool64layer2proghighlight_gqa
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/1dpool64layer2proghighlight_gqa.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/1dpool64layer2proghighlight_gqa.out
#SBATCH --gpus=8
#SBATCH --nodes=1
...
layer=2
grouping=avgpool1d
ckpt=$ROOT_WEIGHT/1dpool64layer2proghighlight
