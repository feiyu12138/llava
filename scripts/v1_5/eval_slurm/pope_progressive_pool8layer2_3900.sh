#!/bin/bash
#
#SBATCH --job-name=pool8layer2prog3900_pope
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/pool8layer2prog3900_pope.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/pool8layer2prog3900_pope.out
#SBATCH --gpus=1
#SBATCH --nodes=1
