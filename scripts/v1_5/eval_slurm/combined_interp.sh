#!/bin/bash
#
#SBATCH --job-name=interp_combine
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/interp_combine.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/interp_combine.out
#SBATCH --gpus=8
#SBATCH --nodes=1
...
CKPT=$ROOT_WEIGHT/llava-v1.5-7b-interp
NAME=interp
