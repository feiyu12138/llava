#!/bin/bash
#
#SBATCH --job-name=1dpool8layer2reverse
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/1dpool8layer2reverse.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/1dpool8layer2reverse.out
#SBATCH --gpus=8
#SBATCH --nodes=1
