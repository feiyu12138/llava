...
#
#SBATCH --job-name=mme
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/dhkpool8layer2uvpe1d_mme.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/dhkpool8layer2uvpe1d_mme.out
#SBATCH --gpus=1
#SBATCH --nodes=1
