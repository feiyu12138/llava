#!/bin/bash
#
#SBATCH --job-name=interp_gqa
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/interp_gqa.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/interp_gqa.out
#SBATCH --gpus=8
#SBATCH --nodes=1
