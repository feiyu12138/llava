...
#SBATCH --error=/datasets/jchen293/logs/exp/llava/attnpool8layer2fine3controlexp_mmvet.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava/attnpool8layer2fine3controlexp_mmvet.out
#SBATCH --gpus=1
#SBATCH --nodes=1
