#!/bin/bash
#
#SBATCH --job-name=mlevel_llavaw
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/mlevel_llavaw.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/mlevel_llavaw.out
#SBATCH --gpus=1
#SBATCH --nodes=1
