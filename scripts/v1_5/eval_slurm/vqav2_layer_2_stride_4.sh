#!/bin/bash
#
#SBATCH --job-name=vqav2_1dpool4layer2
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/1dpool4layer2_vqav2.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/1dpool4layer2_vqav2.out
#SBATCH --gpus=8
#SBATCH --nodes=1
