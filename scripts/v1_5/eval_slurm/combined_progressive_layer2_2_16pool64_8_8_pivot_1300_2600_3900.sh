#!/bin/bash
#
#SBATCH --job-name=1dpool64_8_8_layer2_2_16pivot1300_2600_3900_combined
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/1dpool64_8_8_layer2_2_16pivot1300_2600_3900_combined.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/1dpool64_8_8_layer2_2_16pivot1300_2600_3900_combined.out
#SBATCH --gpus=8
#SBATCH --nodes=1
...
CKPT=$ROOT_WEIGHT/llava-v1.5-7b-1dpool64_8_8_layer2_2_16pivot1300_2600_3900
NAME=1dpool64_8_8_layer2_2_16pivot1300_2600_3900
