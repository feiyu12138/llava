...
#SBATCH --error=/datasets/jchen293/logs/exp/llava/1dpool8layer2uvpedhk_mmvet.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava/1dpool8layer2uvpedhk_mmvet.out
#SBATCH --gpus=1
#SBATCH --nodes=1
