#!/bin/bash
#
#SBATCH --job-name=1dpool8layer8_combine
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/1dpool8layer8_combine.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/1dpool8layer8_combined.out
#SBATCH --gpus=8
#SBATCH --nodes=1
...
CKPT=$ROOT_WEIGHT/llava-v1.5-7b-stride-4-layer-8-grouping-avgpool1d
NAME=1dpool8layer8
layer=8
stride=6
grouping=avgpool1d
