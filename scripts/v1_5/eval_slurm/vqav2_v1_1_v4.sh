#!/bin/bash
#
#SBATCH --job-name=vqav2_v1_1_v4
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/v1_1_v4_vqav2.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/v1_1_v4_vqav2.out
#SBATCH --gpus=8
#SBATCH --nodes=1
