#!/bin/bash
#
#SBATCH --job-name=1dpool2layer2_gqa-v2
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/1dpool2layer2_gqa-v2.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/1dpool2layer2_gqa-v2.out
#SBATCH --gpus=8
#SBATCH --nodes=1
