#!/bin/bash
#
#SBATCH --job-name=1dpool8_8_2_layer2_16_16pivot1300_2600_3900_vqav2
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/1dpool8_8_2_layer2_16_16pivot1300_2600_3900_vqav2.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/1dpool8_8_2_layer2_16_16pivot1300_2600_3900_vqav2.out
#SBATCH --gpus=8
#SBATCH --nodes=1
