#!/bin/bash
#
#SBATCH --job-name=1dpool8_8_2layer2_16_16pivot1300_2600_3900_v2_vqav2
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/1dpool8_8_2layer2_16_16pivot1300_2600_3900_v2_vqa.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/1dpool8_8_2layer2_16_16pivot1300_2600_3900_v2_vqa.out
#SBATCH --gpus=8
#SBATCH --nodes=1
