...
#
#SBATCH --job-name=gqa
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/attnpool16layer2fine3_gqa.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/attnpool16layer2fine3_gqa.out
#SBATCH --gpus=8
#SBATCH --nodes=1
