...
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/pool8layer2prog2600hl_pope.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/pool8layer2prog2600hl_pope.out
#SBATCH --gpus=1
#SBATCH --nodes=1
