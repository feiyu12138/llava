...
#
#SBATCH --job-name=sqa
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/skpool8layer2uvpe_sqa.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/skpool8layer2uvpe_sqa.out
#SBATCH --gpus=1
#SBATCH --nodes=1
