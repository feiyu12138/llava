#!/bin/bash
#
#SBATCH --job-name=1dpool288layer8_gqa
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/1dpool288layer8_gqa.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/1dpool288layer8_gqa.out
#SBATCH --gpus=8
#SBATCH --nodes=1
