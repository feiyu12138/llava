#!/bin/bash
#
#SBATCH --job-name=vqav2_v1_4_v6
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/v1_4_v6_vqav2.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/v1_4_v6_vqav2.out
#SBATCH --gpus=8
#SBATCH --nodes=1
