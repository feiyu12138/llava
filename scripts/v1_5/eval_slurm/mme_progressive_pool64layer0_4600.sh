...
#
#SBATCH --job-name=mme
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/pool64layer0prog4600_mme.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/pool64layer0prog4600_mme.out
#SBATCH --gpus=1
#SBATCH --nodes=1
