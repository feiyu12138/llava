#!/bin/bash
#
#SBATCH --job-name=reprod_lora_llavaw
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/reprod_lora_llavaw.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/reprod_lora_llavaw.out
#SBATCH --gpus=1
#SBATCH --nodes=1
