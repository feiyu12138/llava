#!/bin/bash
#
#SBATCH --job-name=rvpe_gqa
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/rvpe_gqa.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/rvpe_gqa.out
#SBATCH --gpus=8
#SBATCH --nodes=1
