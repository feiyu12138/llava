#!/bin/bash
#
#SBATCH --job-name=v_35_llavaw
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/v_35_llavaw.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/v_35_llavaw.out
#SBATCH --gpus=1
#SBATCH --nodes=1
