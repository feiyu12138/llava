#!/bin/bash
#
#SBATCH --job-name=1dpool16layer0_seed
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/1dpool16layer0_seed.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/1dpool16layer0_seed.out
#SBATCH --gpus=8
#SBATCH --nodes=1
