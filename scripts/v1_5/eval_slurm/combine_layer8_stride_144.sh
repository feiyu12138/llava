#!/bin/bash
#
#SBATCH --job-name=1dpool144layer8_combined
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/1dpool144layer8_combined.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/1dpool144layer8_combined.out
#SBATCH --gpus=8
#SBATCH --nodes=1
...
CKPT=$ROOT_WEIGHT/llava-v1.5-7b-stride-144-layer-8-grouping-avgpool1d
NAME=1dpool144layer8
layer=8
stride=144
grouping=avgpool1d
