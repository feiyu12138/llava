#!/bin/bash
#
#SBATCH --job-name=ablation_70_gqa
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/ablation_70_gqa.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/ablation_70_gqa.out
#SBATCH --gpus=8
#SBATCH --nodes=1
