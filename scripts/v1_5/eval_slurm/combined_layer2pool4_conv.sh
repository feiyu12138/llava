#!/bin/bash
#
#SBATCH --job-name=convpool4layer2_combined
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/convpool4layer2_combined.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/convpool4layer2_combined.out
#SBATCH --gpus=8
#SBATCH --nodes=1
...
CKPT=$ROOT_WEIGHT/llava-v1.5-7b-finetune-stride-4-layer-2-grouping-Convabstractor
NAME=convpool4layer2

layer=2
stride=4
grouping=Convabstractor
# LOG_PREFIX=${NAME}-textvqa;cat /datasets/jchen293/logs/exp/llava_eval/${LOG_PREFIX}.err
run_mmbench_cn() {
    local GPU_ID=$1
    local LOG_PREFIX=$2
