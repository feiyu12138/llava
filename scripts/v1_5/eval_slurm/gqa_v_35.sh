#!/bin/bash
#
#SBATCH --job-name=v_35_gqa
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/v_35_gqa.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/v_35_gqa.out
#SBATCH --gpus=8
#SBATCH --nodes=1
