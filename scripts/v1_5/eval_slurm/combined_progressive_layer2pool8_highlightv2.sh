#!/bin/bash
#
#SBATCH --job-name=1dpool8layer2proghighlight_v2_combined
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/1dpool8layer2proghighlight_v2_combined.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/1dpool8layer2proghighlight_v2_combined.out
#SBATCH --gpus=8
#SBATCH --nodes=1
...
CKPT=$ROOT_WEIGHT/llava-v1.5-7b-1dpool8layer2proghighlight_v2
NAME=1dpool8layer2proghighlight_v2
