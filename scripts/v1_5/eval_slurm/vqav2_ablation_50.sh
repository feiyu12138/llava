#!/bin/bash
#
#SBATCH --job-name=vqav2_ablation_50
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/ablation_50_vqav2.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/ablation_50_vqav2.out
#SBATCH --gpus=8
#SBATCH --nodes=3
...
CKPT=/datasets/jchen293/data/llava_datasets/zhongrui/vlm_synthetic_data/LLaVA/checkpoints/llava-v1.5-7b-ablation_finetune_v1_0.5_luoxin
NAME=ablation_50_luoxin_new
