#!/bin/bash
#
#SBATCH --job-name=vqav2_1dpool_16_16_4layer_2_16_16pivot_1730_3460
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/1dpool_16_16_4layer_2_16_16pivot_1730_3460_vqav2.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/1dpool_16_16_4layer_2_16_16pivot_1730_3460_vqav2.out
#SBATCH --gpus=8
#SBATCH --nodes=1
