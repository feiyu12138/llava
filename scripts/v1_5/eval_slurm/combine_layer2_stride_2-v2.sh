#!/bin/bash
#
#SBATCH --job-name=1dpool2layer2_combined_v2
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/1dpool2layer2_combined_v2.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/1dpool2layer2_combined_v2.out
#SBATCH --gpus=8
#SBATCH --nodes=1
...
CKPT=$ROOT_WEIGHT/llava-v1.5-7b-stride-2-layer-2-grouping-avgpool1d-v2
NAME=1dpool2layer2-v2_
layer=2
stride=2
grouping=avgpool1d
...
run_seed(){
    ...
    python scripts/convert_seed_for_submission.py \
        ...
        > $ROOT_DATA/eval_luoxin/eval/seed_bench/answers_upload/$NAME.txt
}
