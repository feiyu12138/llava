...
#
#SBATCH --job-name=sqa
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/pool64layer2prog4600_sqa.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/pool64layer2prog4600_sqa.out
#SBATCH --gpus=1
#SBATCH --nodes=1
