#!/bin/bash
#
#SBATCH --job-name=v1_1_v4_combined
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/v1_1_v4_combined_jc.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/v1_1_v4_combined_jc.out
#SBATCH --gpus=8
#SBATCH --nodes=1
...
CKPT=/datasets/jchen293/data/llava_datasets/zhongrui/vlm_synthetic_data/LLaVA/checkpoints/llava-v1.5-7b-syn-v1.1-v4
NAME=v1_1_v4
