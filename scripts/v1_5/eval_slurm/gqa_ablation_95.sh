#!/bin/bash
#
#SBATCH --job-name=ablation_95_gqa
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/ablation_95_gqa.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/ablation_95_gqa.out
#SBATCH --gpus=0
#SBATCH --nodes=1
