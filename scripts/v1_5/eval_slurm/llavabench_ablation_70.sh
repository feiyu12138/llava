#!/bin/bash
#
#SBATCH --job-name=ablation_70_llavaw
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/ablation_70_llavaw.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/ablation_70_llavaw.out
#SBATCH --gpus=1
#SBATCH --nodes=1
