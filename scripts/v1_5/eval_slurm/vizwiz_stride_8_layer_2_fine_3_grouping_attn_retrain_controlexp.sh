...
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/attnpool8layer2fine3controlexp_vizwiz.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/attnpool8layer2fine3controlexp_vizwiz.out
#SBATCH --gpus=1
#SBATCH --nodes=1
