#!/bin/bash
#
#SBATCH --job-name=1dpool8_2layer2_2pivot1730_3460_lw
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/1dpool8_2layer2_2pivot1730_3460_lw.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/1dpool8_2layer2_2pivot1730_3460_lw.out
#SBATCH --gpus=1
#SBATCH --nodes=1
