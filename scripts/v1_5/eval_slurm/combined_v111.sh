#!/bin/bash
#
#SBATCH --job-name=v111_combined
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/v111_combined.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/v111_combined.out
#SBATCH --gpus=8
#SBATCH --nodes=1
...
CKPT=/datasets/jchen293/data/llava_datasets/zhongrui/vlm_synthetic_data/LLaVA/checkpoints/llava-v1.5-7b-syn-v111
NAME=v111
