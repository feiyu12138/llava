#!/bin/bash
#
#SBATCH --job-name=2epoch_luoxin_combined
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/2epoch_luoxin_combined.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/2epoch_luoxin_combined.out
#SBATCH --gpus=8
#SBATCH --nodes=1
...
CKPT=/datasets/jchen293/data/llava_datasets/zhongrui/vlm_synthetic_data/LLaVA/checkpoints/llava-2epoch-luoxin
NAME=2epoch-luoxin
