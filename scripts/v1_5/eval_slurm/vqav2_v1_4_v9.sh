#!/bin/bash
#
#SBATCH --job-name=vqav2_v1_4_v9
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/v1_4_v9_vqav2.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/v1_4_v9_vqav2.out
#SBATCH --gpus=8
#SBATCH --nodes=1
...
CKPT=/datasets/jchen293/data/llava_datasets/zhongrui/vlm_synthetic_data/LLaVA/checkpoints/llava-v1.5-7b-syn-v1.4-v9
NAME=v1_4_v9
