#!/bin/bash
#
#SBATCH --job-name=v1_4_llavaw
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/v1_4_v9_llavaw.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/v1_4_v9_llavaw.out
#SBATCH --gpus=1
#SBATCH --nodes=1
