#!/bin/bash
#
#SBATCH --job-name=v1_1_v4_gqa
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/v1_1_v4_gqa.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/v1_1_v4_gqa.out
#SBATCH --gpus=8
#SBATCH --nodes=1
