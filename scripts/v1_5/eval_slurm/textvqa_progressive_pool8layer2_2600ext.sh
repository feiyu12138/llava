...
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/pool8layer2prog2600ext_textvqa.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/pool8layer2prog2600ext_textvqa.out
#SBATCH --gpus=1
#SBATCH --nodes=1
