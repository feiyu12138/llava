#!/bin/bash
#
#SBATCH --job-name=1dpool16layer16v2
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/1dpool16layer16v2.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/1dpool16layer16v2.out
#SBATCH --gpus=8
#SBATCH --nodes=1
...
CKPT=$ROOT_WEIGHT/llava-v1.5-7b-stride-16-layer-16-grouping-avgpool1d-v2
NAME=1dpool16layer16v2
grouping=avgpool1d
stride=16
layer=16
