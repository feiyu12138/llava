#!/bin/bash
#
#SBATCH --job-name=1dpool_16_16_4layer_2_16_16pivot_1730_3460prog_seed
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/1dpool_16_16_4layer_2_16_16pivot_1730_3460prog_seed.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/1dpool_16_16_4layer_2_16_16pivot_1730_3460prog_seed.out
#SBATCH --gpus=8
#SBATCH --nodes=1
