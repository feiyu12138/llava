#!/bin/bash
#
#SBATCH --job-name=interp-compressed_gqa
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/interp-compressed_gqa.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/interp-compressed_gqa.out
#SBATCH --gpus=8
#SBATCH --nodes=1
