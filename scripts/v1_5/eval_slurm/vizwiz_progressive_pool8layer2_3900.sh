#!/bin/bash
#
#SBATCH --job-name=pool8layer2prog3900_vizwiz
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/pool8layer2prog3900_vizwiz.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/pool8layer2prog3900_vizwiz.out
#SBATCH --gpus=1
#SBATCH --nodes=1
