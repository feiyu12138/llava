#!/bin/bash
#
#SBATCH --job-name=vqav2_v1_4_v2
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/v1_4_v2_vqav2_jc.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/v1_4_v2_vqav2_jc.out
#SBATCH --gpus=8
#SBATCH --nodes=1
