...
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/pool8layer2prog2600_textvqa.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/pool8layer2prog2600_textvqa.out
#SBATCH --gpus=1
#SBATCH --nodes=1
...
stride=8
layer=0
ckpt=$ROOT_WEIGHT/llava-v1.5-7b-finetune-stride-8-layer-2-grouping-avgpool1d-unified_vpe-False-progressive
