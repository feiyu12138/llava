#!/bin/bash
#
#SBATCH --job-name=layer2_2_16pool8_2_2_pivot_1730_3460_llavaw
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/layer2_2_16pool8_2_2_pivot_1730_3460_llavaw.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/layer2_2_16pool8_2_2_pivot_1730_3460_llavaw.out
#SBATCH --gpus=1
#SBATCH --nodes=1
