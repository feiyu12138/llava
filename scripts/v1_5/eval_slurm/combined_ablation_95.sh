#!/bin/bash
#
#SBATCH --job-name=ablation_95_combined
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/ablation_95_combined.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/ablation_95_combined.out
#SBATCH --gpus=8
#SBATCH --nodes=1
