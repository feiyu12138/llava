#!/bin/bash
#
#SBATCH --job-name=pool8layer2inferunpool
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/pool8layer2inferunpool_gqa.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/pool8layer2inferunpool_gqa.out
#SBATCH --gpus=8
#SBATCH --nodes=1
