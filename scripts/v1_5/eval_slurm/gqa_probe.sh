#!/bin/bash
#
#SBATCH --job-name=gqa_probe
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/1dpool8layer2probe_gqa.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/1dpool8layer2probe_gqa.out
#SBATCH --gpus=8
#SBATCH --nodes=1
