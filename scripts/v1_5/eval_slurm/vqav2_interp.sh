#!/bin/bash
#
#SBATCH --job-name=interp_vqav2
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/interp_vqav2.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/interp_vqav2.out
#SBATCH --gpus=8
#SBATCH --nodes=1
