#!/bin/bash
#
#SBATCH --job-name=multilevel_gqa
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/multilevel_gqa.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/multilevel_gqa.out
#SBATCH --gpus=8
#SBATCH --nodes=1
