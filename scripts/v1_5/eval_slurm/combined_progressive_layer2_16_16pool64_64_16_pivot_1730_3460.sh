#!/bin/bash
#
#SBATCH --job-name=1dpool64_64_16layer2_16_16pivot1730_3460prog_combined
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/1dpool64_64_16layer2_16_16pivot1730_3460prog_combined.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/1dpool64_64_16layer2_16_16pivot1730_3460prog_combined.out
#SBATCH --gpus=8
#SBATCH --nodes=1
