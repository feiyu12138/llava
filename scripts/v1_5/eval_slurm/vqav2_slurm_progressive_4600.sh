#!/bin/bash
#
#SBATCH --job-name=vqav2_1dpool8layer2progressive4600
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/1dpool8layer2progressive4600_vqav2.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/1dpool8layer2progressive4600_vqav2.out
#SBATCH --gpus=8
#SBATCH --nodes=1
...
layer=2
unified_vpe=False
ckpt=$ROOT_WEIGHT/llava-v1.5-7b-finetune-stride-$stride-layer-$layer-grouping-$grouping-unified_vpe-$unified_vpe-progressive-4600
