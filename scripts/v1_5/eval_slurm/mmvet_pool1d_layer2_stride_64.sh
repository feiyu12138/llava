#!/bin/bash
#
#SBATCH --job-name=1dpool64layer2_mmvet
#SBATCH --error=/datasets/jchen293/logs/exp/llava/1dpool64layer2_mmvet.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava/1dpool64layer2_mmvet.out
#SBATCH --gpus=1
#SBATCH --nodes=1
