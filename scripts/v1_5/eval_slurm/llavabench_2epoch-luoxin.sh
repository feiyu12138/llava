#!/bin/bash
#
#SBATCH --job-name=2epoch_LUOXIN_llavaw
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/2epoch_LUOXIN_llavaw.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/2epoch_LUOXIN_llavaw.out
#SBATCH --gpus=1
#SBATCH --nodes=1
