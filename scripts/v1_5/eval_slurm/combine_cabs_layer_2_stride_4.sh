#!/bin/bash
#
#SBATCH --job-name=cabspool4layer2_combined
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/cabspool4layer2_combined.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/cabspool4layer2_combined.out
#SBATCH --gpus=8
#SBATCH --nodes=1
