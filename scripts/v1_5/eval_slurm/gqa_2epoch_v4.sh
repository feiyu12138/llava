#!/bin/bash
#
#SBATCH --job-name=2epoch_v4_gqa
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/2epoch_v4_gqa.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/2epoch_v4_gqa.out
#SBATCH --gpus=8
#SBATCH --nodes=1
