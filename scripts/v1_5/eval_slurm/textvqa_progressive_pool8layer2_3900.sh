#!/bin/bash
#
#SBATCH --job-name=pool8layer2prog3900_textvqa
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/pool8layer2prog3900_textvqa.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/pool8layer2prog3900_textvqa.out
#SBATCH --gpus=1
#SBATCH --nodes=1
