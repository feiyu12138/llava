...
#
#SBATCH --job-name=sqa
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/attnpool16layer2fine3_sqa.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/attnpool16layer2fine3_sqa.out
#SBATCH --gpus=1
#SBATCH --nodes=1
