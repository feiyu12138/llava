#!/bin/bash
#
#SBATCH --job-name=v112_combined
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/v112_combined.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/v112_combined.out
#SBATCH --gpus=8
#SBATCH --nodes=1
...
CKPT=/datasets/jchen293/data/llava_datasets/zhongrui/vlm_synthetic_data/LLaVA/checkpoints/llava-v1.5-7b-syn-v112
NAME=v112
