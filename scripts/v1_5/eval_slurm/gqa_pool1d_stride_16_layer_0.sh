#!/bin/bash
#
#SBATCH --job-name=1dpool16layer0_gqa
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/1dpool16layer0_gqa.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/1dpool16layer0_gqa.out
#SBATCH --gpus=8
#SBATCH --nodes=1
