#!/bin/bash
#
#SBATCH --job-name=1dpool64layer2_combined_v2
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/1dpool64layer2_combined_v2.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/1dpool64layer2_combined_v2.out
#SBATCH --gpus=8
#SBATCH --nodes=1
...
CKPT=$ROOT_WEIGHT/llava-v1.5-7b-stride-64-layer-2-grouping-avgpool1d-v2
NAME=1dpool64layer2-v2
layer=2
stride=64
grouping=avgpool1d
