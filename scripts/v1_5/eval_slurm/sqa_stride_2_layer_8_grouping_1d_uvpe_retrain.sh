...
#
#SBATCH --job-name=sqa
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/1dpool8layer2uvpe1d_sqa.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/1dpool8layer2uvpe1d_sqa.out
#SBATCH --gpus=1
#SBATCH --nodes=1
