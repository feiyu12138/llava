#!/bin/bash
#
#SBATCH --job-name=pool8layer2prog3900_mme
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/pool8layer2prog3900_mme.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/pool8layer2prog3900_mme.out
#SBATCH --gpus=1
#SBATCH --nodes=1
