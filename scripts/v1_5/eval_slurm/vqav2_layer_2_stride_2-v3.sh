#!/bin/bash
#
#SBATCH --job-name=vqav2_1dpool2layer2-v3
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/1dpool2layer2_vqav2-v3.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/1dpool2layer2_vqav2-v3.out
#SBATCH --gpus=8
#SBATCH --nodes=1
