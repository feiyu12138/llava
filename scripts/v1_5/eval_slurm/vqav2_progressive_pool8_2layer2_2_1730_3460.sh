#!/bin/bash
#
#SBATCH --job-name=1dpool8_2layer2_2pivot1730_3460_vqav2
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/1dpool8_2layer2_2pivot1730_3460_vqav2.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/1dpool8_2layer2_2pivot1730_3460_vqav2.out
#SBATCH --gpus=8
#SBATCH --nodes=1
