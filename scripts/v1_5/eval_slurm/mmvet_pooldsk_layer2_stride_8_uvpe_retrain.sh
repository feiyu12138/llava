#!/bin/bash
#
#SBATCH --job-name=mmvet_dsk
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/dskpool8layer2uvpedhk_mmvet.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/dskpool8layer2uvpedhk_mmvet.out
#SBATCH --gpus=1
#SBATCH --nodes=1
