#!/bin/bash
#
#SBATCH --job-name=v111_gqa
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/v111_gqa.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/v111_gqa.out
#SBATCH --gpus=8
#SBATCH --nodes=1
