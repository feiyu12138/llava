#!/bin/bash
#
#SBATCH --job-name=pool8layer2inferunpool_vizwiz
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/pool8layer2inferunpool_vizwiz.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/pool8layer2inferunpool_vizwiz.out
#SBATCH --gpus=1
#SBATCH --nodes=1
