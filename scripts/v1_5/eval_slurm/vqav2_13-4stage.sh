#!/bin/bash
#
#SBATCH --job-name=13b-4stage_vqav2
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/13b-4stage_vqav2.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/13b-4stage_vqav2.out
#SBATCH --gpus=8
#SBATCH --nodes=1
...
CKPT=$ROOT_WEIGHT/llava-v1.5-13b-4stage
NAME=13-4stage
