#!/bin/bash
#
#SBATCH --job-name=1dpool4layer16_v3_llavaw
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/1dpool4layer16_v3_llavaw.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/1dpool4layer16_v3_llavaw.out
#SBATCH --gpus=1
#SBATCH --nodes=1
...
NAME=1dpool4layer16_v3
CKPT=$ROOT_WEIGHT/llava-v1.5-7b-stride-4-layer-16-grouping-avgpool1d-v3
