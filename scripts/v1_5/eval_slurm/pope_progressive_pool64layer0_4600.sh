...
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/pool64layer0prog4600_pope.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/pool64layer0prog4600_pope.out
#SBATCH --gpus=1
#SBATCH --nodes=1
