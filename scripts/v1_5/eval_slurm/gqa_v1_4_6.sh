#!/bin/bash
#
#SBATCH --job-name=v1_4_v6_gqa
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/v1_4_v6_gqa.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/v1_4_v6_gqa.out
#SBATCH --gpus=8
#SBATCH --nodes=1
