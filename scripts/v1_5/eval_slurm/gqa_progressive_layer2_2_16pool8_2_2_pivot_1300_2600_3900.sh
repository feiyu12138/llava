#!/bin/bash
#
#SBATCH --job-name=1dpool8_2_2_layer2_2_16pivot1300_2600_3900_gqa
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/1dpool8_2_2_layer2_2_16pivot1300_2600_3900_gqa.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/1dpool8_2_2_layer2_2_16pivot1300_2600_3900_gqa.out
#SBATCH --gpus=8
#SBATCH --nodes=1
...
name=1dpool8_2_2_layer2_2_16pivot1300_2600_3900
