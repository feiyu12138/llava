#!/bin/bash
#
#SBATCH --job-name=vqav2_layer2_2_16pool8_2_2_pivot_1730_3460
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/layer2_2_16pool8_2_2_pivot_1730_3460_vqav2.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/layer2_2_16pool8_2_2_pivot_1730_3460_vqav2.out
#SBATCH --gpus=8
#SBATCH --nodes=1
