#!/bin/bash
#
#SBATCH --job-name=pool8layer2prog2600ext_gqa
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/pool8layer2prog2600ext_gqa.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/pool8layer2prog2600ext_gqa.out
#SBATCH --gpus=8
#SBATCH --nodes=1
