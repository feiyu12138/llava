#!/bin/bash
#
#SBATCH --job-name=v35_combined
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/v35_combined.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/v35_combined.out
#SBATCH --gpus=8
#SBATCH --nodes=1
...
CKPT=/datasets/jchen293/data/llava_datasets/zhongrui/vlm_synthetic_data/LLaVA/checkpoints/llava-v1.5-7b-syn-v3.5.2
NAME=v_352
