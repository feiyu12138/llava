#!/bin/bash
#
#SBATCH --job-name=vqav2_v_35_vqav2
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/v_35_vqav2_.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/v_35_vqav2_.out
#SBATCH --gpus=8
#SBATCH --nodes=1
...
CKPT=/datasets/jchen293/data/llava_datasets/zhongrui/vlm_synthetic_data/LLaVA/checkpoints/ablation_finetune_v1_0.85
NAME=ablation_85_
