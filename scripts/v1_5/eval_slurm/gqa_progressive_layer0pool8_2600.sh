#!/bin/bash
#
#SBATCH --job-name=gqa_prog
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/pool8layer0prog2600_gqa.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/pool8layer0prog2600_gqa.out
#SBATCH --gpus=8
#SBATCH --nodes=1
