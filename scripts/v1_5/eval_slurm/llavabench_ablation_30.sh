#!/bin/bash
#
#SBATCH --job-name=ablation_30_llavaw
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/ablation_30_llavaw.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/ablation_30_llavaw.out
#SBATCH --gpus=1
#SBATCH --nodes=1
