...
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/1dpool8layer2uvpe1d_pope.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/1dpool8layer2uvpe1d_pope.out
#SBATCH --gpus=1
#SBATCH --nodes=1
