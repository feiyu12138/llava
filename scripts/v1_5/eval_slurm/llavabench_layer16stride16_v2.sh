#!/bin/bash
#
#SBATCH --job-name=1dpool16layer16_v2_llavaw
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/1dpool16layer16_v2_llavaw.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/1dpool16layer16_v2_llavaw.out
#SBATCH --gpus=1
#SBATCH --nodes=1
