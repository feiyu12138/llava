...
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/dskpool8layer2uvpe_pope.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/dskpool8layer2uvpe_pope.out
#SBATCH --gpus=1
#SBATCH --nodes=1
