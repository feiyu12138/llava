#!/bin/bash
#
#SBATCH --job-name=1dpool8_8_2layer2_16_16pivot1730_3460prog_seed
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/1dpool8_8_2layer2_16_16pivot1730_3460prog_seed.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/1dpool8_8_2layer2_16_16pivot1730_3460prog_seed.out
#SBATCH --gpus=8
#SBATCH --nodes=1
