...
#
#SBATCH --job-name=mme
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/pool8layer0prog2600_mme.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/pool8layer0prog2600_mme.out
#SBATCH --gpus=1
#SBATCH --nodes=1
