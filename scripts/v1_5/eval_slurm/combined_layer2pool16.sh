#!/bin/bash
#
#SBATCH --job-name=1dpool16layer2_combined
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/1dpool16layer2_combined.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/1dpool16layer2_combined.out
#SBATCH --gpus=8
#SBATCH --nodes=1
