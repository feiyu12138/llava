#!/bin/bash
#
#SBATCH --job-name=ablation_70_combined
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/ablation_70_combined.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/ablation_70_combined.out
#SBATCH --gpus=8
#SBATCH --nodes=1
...
CKPT=/datasets/jchen293/data/llava_datasets/zhongrui/vlm_synthetic_data/LLaVA/checkpoints/llava-v1.5-7b-ablation_finetune_v1_0.7_luoxin
NAME=ablation_70_luoxin
