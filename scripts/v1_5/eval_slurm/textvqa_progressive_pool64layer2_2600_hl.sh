#!/bin/bash
#
#SBATCH --job-name=1dpool64layer2proghighlight_mme_textvqa
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/1dpool64layer2proghighlight_mme_textvqa.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/1dpool64layer2proghighlight_mme_textvqa.out
#SBATCH --gpus=1
#SBATCH --nodes=1
