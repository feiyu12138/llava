...
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/attnpool8layer2fine3controlexp_textvqa.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/attnpool8layer2fine3controlexp_textvqa.out
#SBATCH --gpus=1
#SBATCH --nodes=1
