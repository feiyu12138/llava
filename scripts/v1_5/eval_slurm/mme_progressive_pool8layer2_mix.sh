...
#
#SBATCH --job-name=mme
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/pool8layer2prog2600mix_mme.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/pool8layer2prog2600mix_mme.out
#SBATCH --gpus=1
#SBATCH --nodes=1
