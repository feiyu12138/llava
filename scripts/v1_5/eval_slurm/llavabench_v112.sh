#!/bin/bash
#
#SBATCH --job-name=v112_llavaw
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/v112_llavaw.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/v112_llavaw.out
#SBATCH --gpus=1
#SBATCH --nodes=1
