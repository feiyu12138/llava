#!/bin/bash
#
#SBATCH --job-name=vccpool8layer2-infer_combined
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/vccpool8layer2-infer_combined.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/vccpool8layer2-infer_combined.out
#SBATCH --gpus=8
#SBATCH --nodes=1
...
# run_sqa 5 "${NAME}-sqa"
run_llavabench 5 "${NAME}-llavabench"
