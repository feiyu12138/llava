#!/bin/bash
#
#SBATCH --job-name=lora_reprod_combined
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/lora_reprod_combined.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/lora_reprod_combined.out
#SBATCH --gpus=8
#SBATCH --nodes=1
