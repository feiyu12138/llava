...
#SBATCH --error=/datasets/jchen293/logs/exp/llava/pool8layer2prog2600mixaug_mmvet.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava/pool8layer2prog2600mixaug_mmvet.out
#SBATCH --gpus=1
#SBATCH --nodes=1
