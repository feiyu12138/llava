#!/bin/bash
#
#SBATCH --job-name=pool8layer2prog3900_mmvet
#SBATCH --error=/datasets/jchen293/logs/exp/llava/pool8layer2prog3900_mmvet.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava/pool8layer2prog3900_mmvet.out
#SBATCH --gpus=1
#SBATCH --nodes=1
