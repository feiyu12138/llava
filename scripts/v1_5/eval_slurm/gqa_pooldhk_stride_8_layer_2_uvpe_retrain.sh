...
#
#SBATCH --job-name=gqa
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/dhkpool8layer2uvpe1d_gqa.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/dhkpool8layer2uvpe1d_gqa.out
#SBATCH --gpus=8
#SBATCH --nodes=1
