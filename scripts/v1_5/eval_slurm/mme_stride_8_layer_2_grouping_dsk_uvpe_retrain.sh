#!/bin/bash
#
#SBATCH --job-name=mme_dsk
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/dskpool8layer2uvpe1d_mme.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/dskpool8layer2uvpe1d_mme.out
#SBATCH --gpus=1
#SBATCH --nodes=1
