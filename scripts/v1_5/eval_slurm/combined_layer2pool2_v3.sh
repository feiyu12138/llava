#!/bin/bash
#
#SBATCH --job-name=1dpool2layer2_combined-v3
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/1dpool2layer2_combined-v3.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/1dpool2layer2_combined-v3.out
#SBATCH --gpus=8
#SBATCH --nodes=1
...
CKPT=$ROOT_WEIGHT/llava-v1.5-7b-stride-2-layer-2-grouping-avgpool1d-v3
