#!/bin/bash
#
#SBATCH --job-name=1dpool64layer2_16pivot1300_2600prog_gqa
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/1dpool64layer2_16pivot1300_2600prog_gqa.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/1dpool64layer2_16pivot1300_2600prog_gqa.out
#SBATCH --gpus=8
#SBATCH --nodes=1
...
ckpt=$ROOT_WEIGHT/llava-v1.5-7b-1dpool64layer2_16pivot1300_2600prog
name=1dpool64layer2_16pivot1300_2600prog
