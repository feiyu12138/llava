#!/bin/bash
#
#SBATCH --job-name=interp-compressed_combine
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/interp-compressed_combine.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/interp-compressed_combine.out
#SBATCH --gpus=8
#SBATCH --nodes=1
