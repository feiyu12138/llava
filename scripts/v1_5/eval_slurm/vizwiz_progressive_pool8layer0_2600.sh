...
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/pool8layer0prog2600_vizwiz.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/pool8layer0prog2600_vizwiz.out
#SBATCH --gpus=1
#SBATCH --nodes=1
