#!/bin/bash
#
#SBATCH --job-name=1dpool8_2_2layer2_2_16pivot1300_2600_3900prog_combined
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/1dpool8_2_2layer2_2_16pivot1300_2600_3900prog_combined.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/1dpool8_2_2layer2_2_16pivot1300_2600_3900prog_combined.out
#SBATCH --gpus=8
#SBATCH --nodes=1
