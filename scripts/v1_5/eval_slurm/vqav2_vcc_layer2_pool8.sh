#!/bin/bash
#
#SBATCH --job-name=vccpool16layer2_vqav2
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/vccpool16layer2_vqav2.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/vccpool16layer2_vqav2.out
#SBATCH --gpus=8
#SBATCH --nodes=1
...
CKPT=$ROOT_WEIGHT/llava-v1.5-7b-stride-16-layer-2-grouping-attn-num_fine_block-3
