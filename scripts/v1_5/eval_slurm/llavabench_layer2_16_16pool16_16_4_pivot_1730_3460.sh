#!/bin/bash
#
#SBATCH --job-name=1dpool_16_16_4layer_2_16_16pivot_1730_3460_llavaw
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/1dpool_16_16_4layer_2_16_16pivot_1730_3460_llavaw.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/1dpool_16_16_4layer_2_16_16pivot_1730_3460_llavaw.out
#SBATCH --gpus=1
#SBATCH --nodes=1
