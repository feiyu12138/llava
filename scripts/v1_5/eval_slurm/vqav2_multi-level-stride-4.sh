#!/bin/bash
#
#SBATCH --job-name=multilevel_vqav2
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/multilevel_vqav2.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/multilevel_vqav2.out
#SBATCH --gpus=8
#SBATCH --nodes=1
...
NAME=multi-level-stride-4-infer
