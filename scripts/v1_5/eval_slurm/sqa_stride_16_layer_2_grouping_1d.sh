#!/bin/bash
#
#SBATCH --job-name=1dpool16layer2_sqa
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/1dpool16layer2_sqa.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/1dpool16layer2_sqa.out
#SBATCH --gpus=1
#SBATCH --nodes=1
