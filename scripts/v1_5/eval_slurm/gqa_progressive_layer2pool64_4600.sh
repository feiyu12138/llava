...
#
#SBATCH --job-name=gqa
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/pool64layer2prog4600_gqa.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/pool64layer2prog4600_gqa.out
#SBATCH --gpus=8
#SBATCH --nodes=1
