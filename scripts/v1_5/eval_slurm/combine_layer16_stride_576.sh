#!/bin/bash
#
#SBATCH --job-name=1dpool576layer16
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/1dpool576layer16.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/1dpool576layer16.out
#SBATCH --gpus=8
#SBATCH --nodes=1
...
CKPT=$ROOT_WEIGHT/llava-v1.5-7b-stride-576-layer-16-grouping-avgpool1d
NAME=1dpool576layer16
layer=16
stride=576
grouping=avgpool1d
