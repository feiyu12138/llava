#!/bin/bash
#
#SBATCH --job-name=1dpool8_8_2_layer2_16_16pivot1300_2600_3900prog_lw
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/1dpool8_8_2_layer2_16_16pivot1300_2600_3900prog_lw.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/1dpool8_8_2_layer2_16_16pivot1300_2600_3900prog_lw.out
#SBATCH --gpus=8
#SBATCH --nodes=1
