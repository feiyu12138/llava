#!/bin/bash
#
#SBATCH --job-name=1dpool8layer16_combine
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/1dpool8layer16_combine.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/1dpool8layer16_combined.out
#SBATCH --gpus=8
#SBATCH --nodes=1
...
CKPT=$ROOT_WEIGHT/llava-v1.5-7b-stride-8-layer-16-grouping-avgpool1d
NAME=1dpool8layer16
layer=16
grouping=avgpool1d
stride=8
