#!/bin/bash
#
#SBATCH --job-name=vqav2_ablation_30
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/ablation_30_vqav2.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/ablation_30_vqav2.out
#SBATCH --gpus=8
#SBATCH --nodes=1
