#!/bin/bash
#
#SBATCH --job-name=v1_1_v3_seed
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/v1_1_v3_seed.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/v1_1_v3_seed.out
#SBATCH --gpus=8
#SBATCH --nodes=1
