#!/bin/bash
#
#SBATCH --job-name=v1_1_v4_seed
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/v1_1_v4_seed.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/v1_1_v4_seed.out
#SBATCH --gpus=8
#SBATCH --nodes=1
