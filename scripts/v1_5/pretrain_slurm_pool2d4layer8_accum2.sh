#!/bin/bash
#
#SBATCH --job-name=pt_2dpool4layer8_accum2
#SBATCH --error=/datasets/jchen293/logs/exp/llava/pt_2dpool4layer8_accum2.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava/pt_2dpool4layer8_accum2.out
#SBATCH --gpus=8
#SBATCH --nodes=1
...
deepspeed llava/train/train_mem.py \
    ...
    --report_to wandb \
    --run_name pt_2dpool4layer8_accum2 \
    --stride $stride \
    --layer $layer \
    --grouping $grouping
