#!/bin/bash
#
#SBATCH --job-name=ft_2dpool4layer16
#SBATCH --error=/datasets/jchen293/logs/exp/llava/ft_2dpool4layer16.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava/ft_2dpool4layer16.out
#SBATCH --gpus=8
#SBATCH --nodes=1
