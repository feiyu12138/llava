#!/bin/bash
#
#SBATCH --job-name=pt_dsk_l2s8_uvpe
#SBATCH --error=/datasets/jchen293/logs/exp/llava/pt_dsk_l2s8_uvpe.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava/pt_dsk_l2s8_uvpe.out
#SBATCH --gpus=8
#SBATCH --nodes=1
...
deepspeed llava/train/train_mem.py \
    ...
    --report_to wandb \
    --run_name ptdskmeanslayer2stride8 \
    --stride $stride \
    --layer $layer \
    --grouping $grouping \
    --halfpool $halfpool \
