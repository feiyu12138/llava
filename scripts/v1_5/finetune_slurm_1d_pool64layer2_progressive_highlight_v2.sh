#!/bin/bash
#
#SBATCH --job-name=1dpool64layer2proghighlight_v2
#SBATCH --error=/datasets/jchen293/logs/exp/llava/1dpool64layer2proghighlight_v2.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava/1dpool64layer2proghighlight_v2.out
#SBATCH --gpus=8
#SBATCH --nodes=1
...
deepspeed llava/train/train_mem.py \
    ...
    --bf16 True \
    --output_dir  $ROOT_WEIGHT/llava-v1.5-7b-1dpool64layer2proghighlight_v2 \
    --num_train_epochs 1 \
