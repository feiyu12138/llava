...
#SBATCH --error=/datasets/jchen293/logs/exp/gen_llava/2epoch.err
#SBATCH --output=/datasets/jchen293/logs/exp/gen_llava/2epoch.out
#SBATCH --gpus=8
#SBATCH --nodes=1
...
deepspeed llava/train/train_mem.py \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-2epoch \
    --num_train_epochs 2 \
    ...
    --report_to wandb \
    --run_name 2epoch \
    > /datasets/jchen293/logs/exp/gen_llava/llava_2epoch.log
