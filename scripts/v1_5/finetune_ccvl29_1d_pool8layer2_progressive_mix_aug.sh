...
deepspeed llava/train/train_mem.py \
    ...
    --model_name_or_path lmsys/vicuna-7b-v1.5 \
    --version v1 \
    --data_path $ROOT_DATA/LLaVA-Tuning/json/llava_v1_5_mix665k_combine_aug.json \
    ...
    --bf16 True \
    --output_dir  $ROOT_WEIGHT/llava-v1.5-7b-finetune-stride-$stride-layer-$layer-grouping-$grouping-unified_vpe-$unified_vpe-progressive-mix-aug \
    --num_train_epochs 1 \
    ...
    --lazy_preprocess True \
    --report_to wandb \
    --run_name 1dpool8layer2progmixaug \
    --stride $stride \
    --layer $layer \
    --grouping $grouping \
    --unified_vpe $unified_vpe \
    --progressive $progressive \
    1> /data/datasets/jchen293/logs/exp/llava/1dpool8layer2progmixaug.out \
    2> /data/datasets/jchen293/logs/exp/llava/1dpool8layer2progmixaug.err
