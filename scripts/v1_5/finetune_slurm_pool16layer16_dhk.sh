#!/bin/bash
#
#SBATCH --job-name=1dpool16layer16dhk
#SBATCH --error=/datasets/jchen293/logs/exp/llava/1dpool16layer16dhk.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava/1dpoo16layer16dhk.out
#SBATCH --gpus=8
#SBATCH --nodes=1
