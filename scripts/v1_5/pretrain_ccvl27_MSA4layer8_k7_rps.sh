#!/bin/bash
#
#SBATCH --job-name=pt_MSA4layer8_k7_rps
#SBATCH --error=/datasets/jchen293/logs/exp/llava/pt_MSA4layer8_k7_rps.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava/pt_MSA4layer8_k7_rps.out
#SBATCH --gpus=8
#SBATCH --nodes=1
