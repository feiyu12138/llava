#!/bin/bash
#
#SBATCH --job-name=pt_sk_l2s8_uvpe
#SBATCH --error=/datasets/jchen293/logs/exp/llava/pt_sk_l2s8_uvpe.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava/pt_sk_l2s8_uvpe.out
#SBATCH --gpus=8
#SBATCH --nodes=1
...
deepspeed llava/train/train_mem.py \
    ...
    --report_to wandb \
    --run_name ptskmeanslayer2stride8 \
    --stride $stride \
    --layer $layer \
    --grouping $grouping \
    --halfpool $halfpool \
