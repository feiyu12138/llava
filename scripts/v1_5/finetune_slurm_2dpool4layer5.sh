#!/bin/bash
#
#SBATCH --job-name=2dpool4layer5
#SBATCH --error=/datasets/jchen293/logs/exp/llava/2dpool4layer5.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava/2dpool4layer5.out
#SBATCH --gpus=8
#SBATCH --nodes=1
