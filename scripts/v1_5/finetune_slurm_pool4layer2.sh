#!/bin/bash
#
#SBATCH --job-name=pool4layer2
#SBATCH --error=/datasets/jchen293/logs/exp/llava/pool4layer2.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava/pool4layer2.out
#SBATCH --gpus=8
#SBATCH --nodes=1
