#!/bin/bash
#
#SBATCH --job-name=pool2layer16
#SBATCH --error=/datasets/jchen293/logs/exp/llava/pool2layer16.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava/pool2layer16.out
#SBATCH --gpus=8
#SBATCH --nodes=1
