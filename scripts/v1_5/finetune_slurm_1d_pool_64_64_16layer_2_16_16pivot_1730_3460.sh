#!/bin/bash
#
#SBATCH --job-name=1dpool_64_64_16layer_2_16_16pivot_1730_3460
#SBATCH --error=/datasets/jchen293/logs/exp/llava/1dpool_64_64_16layer_2_16_16pivot_1730_3460.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava/1dpool_64_64_16layer_2_16_16pivot_1730_3460.out
#SBATCH --gpus=8
#SBATCH --nodes=1
...
grouping=avgpool1d
progressive=True
name=1dpool_64_64_16layer_2_16_16pivot_1730_3460
