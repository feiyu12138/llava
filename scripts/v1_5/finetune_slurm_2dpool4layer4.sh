#!/bin/bash
#
#SBATCH --job-name=2dpool4layer4
#SBATCH --error=/datasets/jchen293/logs/exp/llava/2dpool4layer4.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava/2dpool4layer4.out
#SBATCH --gpus=8
#SBATCH --nodes=1
...
deepspeed llava/train/train_mem.py \
    ...
    --bf16 True \
    --output_dir /datasets/jchen293/weights/llava/checkpoint/llava-v1.5-7b-stride-$stride-layer-$layer-grouping-$grouping-half \
    --num_train_epochs 1 \
