#!/bin/bash
#
#SBATCH --job-name=pool64layer1
#SBATCH --error=/datasets/jchen293/logs/exp/llava/pool64layer1.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava/pool64layer1.out
#SBATCH --gpus=8
#SBATCH --nodes=1
