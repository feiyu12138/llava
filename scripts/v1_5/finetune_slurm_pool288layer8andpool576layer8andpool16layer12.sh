#!/bin/bash
#
#SBATCH --job-name=pool288layer8andpool576layer8andpool16layer12
#SBATCH --error=/datasets/jchen293/logs/exp/llava/pool288layer8andpool576layer8andpool16layer12.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava/pool288layer8andpool576layer8andpool16layer12.out
#SBATCH --gpus=8
#SBATCH --nodes=1
