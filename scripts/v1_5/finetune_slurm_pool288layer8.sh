#!/bin/bash
#
#SBATCH --job-name=pool288layer8
#SBATCH --error=/datasets/jchen293/logs/exp/llava/pool288layer8.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava/pool288layer8.out
#SBATCH --gpus=8
#SBATCH --nodes=1
