...
deepspeed llava/train/train_mem.py \
    ...
    --bf16 True \
    --output_dir  $ROOT_WEIGHT/llava-v1.5-7b-finetune-stride-$stride-layer-$layer-grouping-$grouping-unified_vpe-$unified_vpe-progressive-pool8pt \
    --num_train_epochs 1 \
    ...
    --lazy_preprocess True \
    --report_to wandb \
    --run_name pool8layer21dprogressivepool8pt \
    --stride $stride \
    --layer $layer \
    --grouping $grouping \
    --unified_vpe $unified_vpe \
