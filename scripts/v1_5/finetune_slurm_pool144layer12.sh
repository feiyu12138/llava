#!/bin/bash
#
#SBATCH --job-name=pool144layer12
#SBATCH --error=/datasets/jchen293/logs/exp/llava/pool144layer12.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava/pool144layer12.out
#SBATCH --gpus=8
#SBATCH --nodes=1
