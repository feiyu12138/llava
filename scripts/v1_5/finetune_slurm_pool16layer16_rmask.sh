#!/bin/bash
#
#SBATCH --job-name=1dpool16layer16rmasking
#SBATCH --error=/datasets/jchen293/logs/exp/llava/1dpool16layer16rmasking.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava/1dpoo16layer16rmasking.out
#SBATCH --gpus=8
#SBATCH --nodes=1
...
deepspeed llava/train/train_mem.py \
    ...
    --report_to wandb \
    --run_name 1dpool16layer16rmasking \
    --stride $stride \
    --layer $layer \
    --grouping $grouping
