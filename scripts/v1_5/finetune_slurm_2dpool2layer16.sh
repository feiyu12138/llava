#!/bin/bash
#
#SBATCH --job-name=2dpool2layer16
#SBATCH --error=/datasets/jchen293/logs/exp/llava/2dpool2layer16.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava/2dpool2layer16.out
#SBATCH --gpus=8
#SBATCH --nodes=1
