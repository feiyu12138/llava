#!/bin/bash
#
#SBATCH --job-name=convpool4_4_2layer2_16_16pivot1300_2600_3900prog
#SBATCH --error=/datasets/jchen293/logs/exp/llava/convpool4_4_2layer2_16_16pivot1300_2600_3900prog.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava/convpool4_4_2layer2_16_16pivot1300_2600_3900prog.out
#SBATCH --gpus=8
#SBATCH --nodes=1
...
progressive=True
name=convpool4_4_2layer2_16_16pivot1300_2600_3900prog
