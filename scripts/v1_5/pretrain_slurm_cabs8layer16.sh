#!/bin/bash
#
#SBATCH --job-name=pt_cabs8layer16
#SBATCH --error=/datasets/jchen293/logs/exp/llava/pt_cabs8layer16.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava/pt_cabs8layer16.out
#SBATCH --gpus=8
#SBATCH --nodes=1
