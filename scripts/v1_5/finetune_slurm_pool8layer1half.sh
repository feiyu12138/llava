#!/bin/bash
#
#SBATCH --job-name=pool8layer1half
#SBATCH --error=/datasets/jchen293/logs/exp/llava/pool8layer1half.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava/pool8layer1half.out
#SBATCH --gpus=8
#SBATCH --nodes=1
