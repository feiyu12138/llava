#!/bin/bash
#
#SBATCH --job-name=pool2layer2-v2
#SBATCH --error=/datasets/jchen293/logs/exp/llava/pool2layer2-v2.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava/pool2layer2-v2.out
#SBATCH --gpus=8
#SBATCH --nodes=1
