...
cd $CLEVRDIR
python eval/eval_easy.py --answer_file ../answer_superclevr_questions_occlusion_ood.jsonl --prediction_file ood_testdev_all_predictions.json > result/ood_cot.txt
