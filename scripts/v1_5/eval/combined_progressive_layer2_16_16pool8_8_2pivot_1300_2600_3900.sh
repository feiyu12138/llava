#!/bin/bash
#
#SBATCH --job-name=1dpool8_8_2_layer2_16_16pivot1300_2600_3900_combined
#SBATCH --error=/datasets/jchen293/logs/exp/llava_eval/1dpool8_8_2_layer2_16_16pivot1300_2600_3900_combined_v2.err
#SBATCH --output=/datasets/jchen293/logs/exp/llava_eval/1dpool8_8_2_layer2_16_16pivot1300_2600_3900_combined_v2.out
#SBATCH --gpus=8
#SBATCH --nodes=1
...
CKPT=$ROOT_WEIGHT/llava-v1.5-7b-1dpool8_8_2layer2_16_16pivot1300_2600_3900_v2
NAME=1dpool8_8_2layer2_16_16pivot1300_2600_3900_v2
