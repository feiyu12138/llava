...
python llava/eval/summarize_gpt_review.py -f /data/jieneng/code/llava_git/llava/playground/data/eval/llava-bench-in-the-wild/reviews/stride-16-layer-16-grouping-avgpool1d.jsonl
