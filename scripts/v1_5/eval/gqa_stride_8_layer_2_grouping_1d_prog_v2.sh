...
CKPT=$ROOT_WEIGHT/llava-v1.5-7b-finetune-stride-8,1-layer-2,0-grouping-avgpool1d-progressive-v2
NAME=1dstride-8-layer-2-grouping-avgpool1d-progressive-v2
