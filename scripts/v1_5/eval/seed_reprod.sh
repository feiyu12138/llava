...
output_file=./playground/data/eval/seed_bench/answers/$name/merge.jsonl
...
for IDX in $(seq 0 $((CHUNKS-1))); do
    cat ./playground/data/eval/seed_bench/answers/$name/${CHUNKS}_${IDX}.jsonl >> "$output_file"
done
...
python scripts/convert_seed_for_submission.py \
    ...
    --result-upload-file ./playground/data/eval/seed_bench/answers_upload/$name.jsonl
