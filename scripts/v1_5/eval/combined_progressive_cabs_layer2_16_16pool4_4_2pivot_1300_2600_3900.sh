...
CKPT=$ROOT_WEIGHT/llava-v1.5-7b-cabspool4_4_2layer2_16_16pivot1300_2600_3900prog
NAME=cabspool4_4_2layer2_16_16
layer=16
stride=1
grouping=cabstractor
# LOG_PREFIX=$NAME-vizwiz;cat /data/datasets/jchen293/logs/exp/llava_eval/${LOG_PREFIX}.out
